...
#         #input prediction shape is: (N, S*S*(C+B*5))
...
# #         ious = torch.stack([iou1,iou2])

#         max_value, best_box = torch.max(ious, dim=0)
...
#         box_predictions = exists_box * ( (1 - best_box)*predictions[...,21:25] + 
